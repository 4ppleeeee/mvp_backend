...
The subtitle-priority flow, yt-dlp audio options, FFmpeg audio extraction and faster-whisper result mapping in `app/ingestion/` are adapted from [JefferyHcool/BiliNote](https://github.com/JefferyHcool/BiliNote).
